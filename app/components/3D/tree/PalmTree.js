...
// 3. Procedural Pinnate Palm Frond with Tapered Semilunar Core (Supports 3D scale arrays)
...
export default function PalmTree({ color, windSpeed = 1.0 }) {
  const leafColor = color || "#15803d"; // Default Palm Green
  ...
  useFrame((state) => {
    ...
    // 2. High-Frequency Leaf Rustle/Crown Wobble
    if (crownRef.current) {
