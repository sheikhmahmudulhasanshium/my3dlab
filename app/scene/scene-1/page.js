  ...
  return (
    <main className="relative min-h-screen w-screen overflow-hidden pt-16">
      ...
      <div className="absolute inset-x-0 bottom-0 z-10 flex p-6 md:p-12 pointer-events-none justify-start">
        <Card className="pointer-events-auto w-full max-w-sm border-white/10 bg-black/40 backdrop-blur-md text-slate-100">
          ...
          <CardContent className="px-5 pb-5">
            <div className="grid grid-cols-3 gap-2">
              <Button variant="outline" className="text-xs text-white" onClick={() => setColor("#00d2ff")}>Blue</Button>
              <Button variant="outline" className="text-xs text-white" onClick={() => setColor("#10b981")}>Green</Button>
              <Button variant="outline" className="text-xs text-white" onClick={() => setColor("#ef4444")}>Red</Button>
            </div>
          </CardContent>
